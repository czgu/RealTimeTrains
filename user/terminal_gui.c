...
char TRAIN_TAB_STOP[TRAIN_NUM_COLS + 1] = {0, 1, 2, 3, 5, 6, 7, 8, 9, 10, 11, 20};
...
inline void init_train_display() {
    ...
    PutStr(COM2, "Train\tSpeed\tAccel\tCurrent arc\tDstance\tN.sensr\tError\tDest\tAlloc\tDealloc\tTrack state");
}
